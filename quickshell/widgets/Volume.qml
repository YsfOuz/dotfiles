...
Item {
    ...
    Component.onCompleted: volProc.exec(["wpctl", "get-volume", "@DEFAULT_AUDIO_SINK@"])
    ...
    Process {
        ...
        stdout: SplitParser { onRead: _ => volProc.exec(["wpctl", "get-volume", "@DEFAULT_AUDIO_SINK@"]) }
    ...
    Process {
        id: setProc
        onRunningChanged: if (!running) volProc.exec(["wpctl", "get-volume", "@DEFAULT_AUDIO_SINK@"])
    }
